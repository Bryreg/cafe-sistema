...
export default function ConteoCierre() {
  ...
  if (loading) return (
    <BaristaLayout title="Conteo de cierre" backTo="/hub">
  ...
  return (
    <BaristaLayout title="Conteo de cierre" backTo="/hub">
      <div className="space-y-5">
        <div>
          <p className="text-xs font-semibold text-amber-600 uppercase tracking-widest mb-1">Paso 4 de 5</p>
          <h1 className="text-xl font-bold text-gray-900">Conteo de cierre</h1>
          <p className="text-sm text-gray-500">Verifica el stock físico al finalizar el turno.</p>
        </div>
        ...
        <button onClick={confirmar} disabled={saving}
          className="w-full bg-gray-900 hover:bg-black disabled:opacity-50 text-white font-bold py-4 rounded-xl text-base flex items-center justify-center gap-2 transition-colors">
