...
DEFAULTS = [
    ...
    {
        "tipo": "horario_publicado",
        "label": "Horario de la semana enviado",
        "descripcion": "Avisa a cada barista cuando el admin publica el horario de su semana. El push llega solo a los dispositivos de esa persona.",
        "unidad": "",
        "umbral": 0,
        "activa": True,
        "canal_bell": True,
    ...
    },
    {
        ...
        "label": "Cambio en un turno ya publicado",
        "descripcion": "Avisa a la barista cuando su turno ya publicado se mueve, se alarga o se da de baja.",
        "unidad": "",
        "umbral": 0,
        "activa": True,
        "canal_bell": True,
    ...
    {
        "tipo": "novedad_laboral",
        "label": "Novedad laboral que pisa un turno publicado",
        "descripcion": "Avisa a la barista cuando se le registra una incapacidad, permiso, vacaciones o ausencia sobre un turno que ya tenía asignado.",
        "unidad": "",
        "umbral": 0,
        "activa": True,
        "canal_bell": True,
