...
import FormatoDesechables from './pages/FormatoDesechables'
...
function AppRoutes() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/formato-desechables" element={<RequireAdmin><Layout><FormatoDesechables /></Layout></RequireAdmin>} />
